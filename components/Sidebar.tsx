...
export default function Sidebar() {
  return (
    <aside className="w-64 flex-shrink-0 border-r border-surface-border bg-sidebar-bg flex flex-col h-full hidden md:flex">
      ...
      <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1 scrollbar-hide animate-fade-in stagger-children">
        <div className="px-3 mb-2 text-xs font-semibold text-zinc-500 uppercase tracking-wider">Discover</div>
        <Link
          className="group flex items-center gap-3 px-3 py-2 text-sm font-medium text-white bg-white/5 rounded-lg border border-primary/20 animate-slide-up"
          href="/"
        >
        ...
        <Link
          className="group flex items-center gap-3 px-3 py-2 text-sm font-medium text-zinc-400 hover:text-white hover:bg-surface-dark rounded-lg transition-all animate-slide-up"
          href="/popular"
        >
        ...
        <div className="px-3 mt-8 mb-2 text-xs font-semibold text-zinc-500 uppercase tracking-wider animate-slide-up">Categories</div>
