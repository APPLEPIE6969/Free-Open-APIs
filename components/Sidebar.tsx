  ...
  return (
    <aside className="w-64 flex-shrink-0 border-r border-surface-border bg-sidebar-bg flex flex-col h-full hidden md:flex">
      ...
      <nav className="flex-1 overflow-y-auto py-6 px-3 space-y-1 scrollbar-hide">
        ...
        <Link
          className="group flex items-center gap-3 px-3 py-2 text-sm font-medium text-white bg-white/5 rounded-lg border border-primary/20 transition-all hover:scale-105"
          href="/"
        >
        ...
        <Link
          className="group flex items-center gap-3 px-3 py-2 text-sm font-medium text-zinc-400 hover:text-white hover:bg-surface-dark rounded-lg transition-all hover:scale-105"
          href="/popular"
        >
      ...
      <div className="p-4 border-t border-surface-border">
        <Link
          className="flex items-center gap-3 px-3 py-2 text-sm font-medium text-zinc-400 hover:text-white hover:bg-surface-dark rounded-lg transition-all hover:scale-105"
          href="/about"
        >
