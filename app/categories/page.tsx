          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-3 md:gap-4 stagger-children">
              {categories.map((category) => (
                <Link
                  key={category.name}
                  className="group p-3 md:p-4 bg-surface-dark rounded-xl border border-surface-border hover:border-primary/50 transition-all hover:scale-105 hover:bg-surface-hover flex flex-col items-center text-center md:items-start md:text-left"
