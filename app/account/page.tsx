    ...
    <div className="flex h-screen overflow-hidden bg-background-dark text-white font-display">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden bg-background-dark relative">
        ...
        <div className="flex-1 overflow-y-auto p-8 flex items-center justify-center flex-col text-center pb-32 md:pb-8 animate-slide-up">
          <span className="material-symbols-outlined text-6xl text-zinc-600 mb-4">account_circle</span>
          <h2 className="text-xl font-semibold mb-2">User Accounts</h2>
          <p className="text-zinc-400 max-w-md">
            User accounts and personalization features are coming soon. You'll be able to save your favorite APIs and manage your submissions.
          </p>
